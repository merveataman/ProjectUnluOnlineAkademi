...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Progress Bar</title>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Sizes</h2>
                        ...
                        <div class="col-xl-6">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Colors & Contextual</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Loading Animations (Duration & Delay)</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="spacer"></div>
                                                <div class="progress">
                                                    <div class="progress-bar bg-success animated bounceInLeft animated-duration-1s animated-delay-400ms" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%;">
                                                        Bounce In Left
                                                    </div>
                                                </div>
                                                <div class="spacer"></div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-info animated flipInY animated-duration-1s animated-delay-600ms" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 30%;">
                                                        Flip
                                                    </div>
                                                </div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-warning animated rotateInUpLeft animated-duration-1s animated-delay-800ms" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
                                                        Rotate Up
                                                    </div>
                                                </div>
                                                <div class="spacer"></div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-danger animated rotateInDownLeft animated-duration-1s animated-delay-1000ms" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%;">
                                                        Rotate Down
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-success animated lightSpeedIn animated-duration-1s animated-delay-1600ms" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%;">
                                                        Light Speed In
                                                    </div>
                                                </div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-info animated zoomIn animated-duration-1s animated-delay-1800ms" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 30%;">
                                                        Zoom In
                                                    </div>
                                                </div>
                                                <div class="spacer"></div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-warning animated zoomInLeft animated-duration-1s animated-delay-2000ms" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
                                                        Zoom In Left
                                                    </div>
                                                </div>
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-danger animated rollIn animated-duration-1s animated-delay-2200ms" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%;">
                                                        Roll In
                                                    </div>
                                                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Stripped</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-6">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Constantly Animated</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                                ...
                                <div class="content-body">    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar bg-success bg-success progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
                                                    <span class="sr-only">40% Complete (success)</span>
                                                </div>
                                            </div>
                                            <div class="spacer"></div>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Stacked</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar bg-success bg-success" style="width: 35%">
                                                <span class="sr-only">35% Complete (success)</span>
                                            </div>
                                            <div class="progress-bar bg-warning bg-warning" style="width: 20%">
                                        ...
                                        <div class="progress progress-md">
                                            <div class="progress-bar bg-danger bg-danger" style="width: 10%">
                                                <span class="sr-only">10% Complete (danger)</span>
                                            </div>
                                            <div class="progress-bar bg-warning progress-bar-striped bg-warning" style="width: 40%">
                                                <span class="sr-only">40% Complete (warning)</span>
                                            </div>
                                            <div class="progress-bar bg-success bg-success" style="width: 25%">
