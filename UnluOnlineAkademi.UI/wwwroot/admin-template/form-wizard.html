...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Form Wizard</title>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Form Wizard with validations</h2>
                                            ...
                                            <div id="pills"class='wizardpills' >
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <nav aria-label="Page navigation example">
                                                        <ul class="pagination wizard justify-content-center">


                                                            <li class="previous first page-item" style="display:none;"><a class="page-link" href="javascript:;">First</a></li>
                                                            <li class="previous page-item"><a class="page-link" href="javascript:;">Previous</a></li>
                                                            <li class="next last page-item" style="display:none;"><a class="page-link" href="javascript:;">Last</a></li>
                                                            <li class="next page-item"><a class="page-link" href="javascript:;">Next</a></li>
                                                            <li class="finish page-item"><a class="page-link" href="javascript:;">Finish</a></li>
