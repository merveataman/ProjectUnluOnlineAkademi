...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Pages</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                <li>
                                    <a class="active" href="blo-pages.html" >All Pages</a>
                                </li>
                                <li>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">All Pages</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="blog_post">
                                            <h3><a href="blo-blog-view.html">About us</a></h3>
                                        ...
                                        <div class="blog_post">
                                            <h3><a href="blo-blog-view.html">Our Features</a></h3>
                                            <h5>Written by <a href="#">Me</a> on May 11, 2013.</h5>
                                            <p class="blog_info">
                                                <i class="fa fa-comment"></i> <a href="#comments">3 comments</a>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="blog_post">
                                            <h3><a href="blo-blog-view.html">Contact us</a></h3>
                                            <h5>Written by <a href="#">Me</a> on May 11, 2013.</h5>
                                            <p class="blog_info">
                                                <i class="fa fa-comment"></i> <a href="#comments">3 comments</a>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="blog_post">
                                            <h3><a href="blo-blog-view.html">Services</a></h3>
                                            <h5>Written by <a href="#">Me</a> on May 11, 2013.</h5>
                                            <p class="blog_info">
                                                <i class="fa fa-comment"></i> <a href="#comments">3 comments</a>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
