...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Search Blogs</title>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Search Blogs</h1>                            </div>
                            ...
                            <div class="content-body">    <div class="row">
                                    ...
                                    <div class="col-lg-12 search_data">
                                        ...
                                        <ul class="nav nav-tabs float-left  vertical col-lg-2 col-xl-2 col-md-3 col-3 left-aligned" id="myTab5" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a href="#contacts-1" data-toggle="tab" role="tab" class="nav-link">
                                                    <i class="fa fa-user"></i> Contacts
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#projects-1" data-toggle="tab" role="tab" class="nav-link">
                                                    <i class="fa fa-bank"></i> Projects
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#map-1" data-toggle="tab" role="tab" class="nav-link">
                                                    <i class="fa fa-location-arrow"></i> Map
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#videos-1" data-toggle="tab" role="tab" class="nav-link">
                                                    <i class="fa fa-video-camera"></i> Videos
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#messages-1" data-toggle="tab" role="tab" class="nav-link">
                                                    <i class="fa fa-envelope"></i> Messages
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#profile-1" data-toggle="tab" role="tab" class="nav-link">
                                        ...
                                        <div class="tab-content float-left  vertical col-xl-10 col-lg-10 col-md-3 col-3 left-aligned" id="myTabContent5">
                                            ...
                                            <div class="tab-pane fade show active" id="web-1">
                                                ...
                                                <div class="search_result">
                                                    <div class="float-left col-md-2 col-3"><img class="img-fluid" src="data/search/1.png"></div>
                                                ...
                                                <div class="search_result">
                                                    <div class="float-left col-md-2 col-3"><img class="img-fluid" src="data/search/2.png"></div>
                                                    <div class="float-left col-md-10 col-9">
                                                        <h4><a href="#">Contrast and Similiarity in Graphic Desigh</a></h4>
                                                        <p>Graphic design is the art of visual communication through the use of images, words, and ideas to give information to the viewers. <a href="#" class="float-right"><small>Read More...</small></a></p>
                                                    </div>
                                                ...
                                                <div class="search_result">
                                                    <div class="float-left col-md-2 col-3"><img class="img-fluid" src="data/search/3.png"></div>
                                                    <div class="float-left col-md-10 col-9">
                                                        <h4><a href="#">Contrast and Similiarity in Graphic Desigh</a></h4>
                                                        <p>Graphic design is the art of visual communication through the use of images, words, and ideas to give information to the viewers. <a href="#" class="float-right"><small>Read More...</small></a></p>
                                                    </div>
                                                ...
                                                <div class="search_result">
                                                    <div class="float-left col-md-2 col-3"><img class="img-fluid" src="data/search/4.png"></div>
                                                    <div class="float-left col-md-10 col-9">
                                                        <h4><a href="#">Contrast and Similiarity in Graphic Desigh</a></h4>
                                                        <p>Graphic design is the art of visual communication through the use of images, words, and ideas to give information to the viewers. <a href="#" class="float-right"><small>Read More...</small></a></p>
                                                    </div>
