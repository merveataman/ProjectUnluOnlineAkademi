...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Members</title>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Our Team</h2>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="row margin-0">
                                            <div class="col-md-6 col-lg-4">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/members/person-1.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>Bin Lodi</h3>
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/members/person-2.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/members/person-3.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-lg-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/members/person-4.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>I. Torkelson</h3>
                                            ...
                                            <div class="col-md-4 col-lg-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/members/person-5.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>Melva Latshaw</h3>
                                            ...
                                            <div class="col-md-4 col-lg-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/members/person-6.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>Clay Peskin</h3>
                                                        <span>Designer</span>
                                            ...
                                            <div class="col-md-4 col-lg-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/members/person-7.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h3>Winford K.</h3>
                                                        <span>UI/UX</span>
