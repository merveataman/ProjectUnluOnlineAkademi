...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Buttons</title>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Check Box &amp; Radio</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">States</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                                ...
                                <div class="content-body">    <div class="row">
                                        ...
                                        <div class="col-lg-6 bottom15 right15">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Styles</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                                ...
                                <div class="content-body">    <div class="row">
                                        <div class="col-lg-3 bottom15 right15"><button type="button" class="btn btn-primary">Square</button></div>
                                        <div class="col-lg-3 bottom15 right15"><button type="button" class="btn btn-primary btn-corner">Cornered</button></div>
                                        <div class="col-lg-3 bottom15 right15"><button type="button" class="btn btn-primary btn-round">Rounded</button></div>
                                        <div class="col-lg-3 bottom15 right15"><button type="button" class="btn btn-primary btn-border">Bordered</button></div>
                                    </div>
                                </div>
                            </section></div>
                    </div>
