...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Inline Editing & Table Grid</title>
        ...
        <link href="assets/plugins/x-editable/css/bootstrap-editable.css" rel="stylesheet" type="text/css" media="screen"/><link href="assets/plugins/icheck/skins/all.css" rel="stylesheet" type="text/css" media="screen"/>        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
    ...
    <body class=" "><!-- START TOPBAR -->
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="inline-editing.html" >Inline Editing</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Inline Editing & Table Grid</h1>                            </div>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Grid Check Box - With Inline</h2>
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style='width:10%'>Discontinued</th>
                                                    <th style='width:15%'>Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xeditin-username" data-type="text" data-pk="1" data-title="Enter username">Sport Shoes</a></td>
                                                    <td><a href="#" class="xeditin-price" data-type="text" data-pk="1" data-title="Enter price">30.00</a></td>
                                                    <td><a href="#" class="xeditin-units" data-type="text" data-pk="1" data-title="Enter units">70</a></td>
                                                    <td><a href="#" class="xeditin-status"></a></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xeditin-username" data-type="text" data-pk="1" data-title="Enter username">HD Laptop</a></td>
                                                    <td><a href="#" class="xeditin-price" data-type="text" data-pk="1" data-title="Enter price">130.00</a></td>
                                                    <td><a href="#" class="xeditin-units" data-type="text" data-pk="1" data-title="Enter units">630</a></td>
                                                    <td><a href="#" class="xeditin-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
                                                ...
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xeditin-username" data-type="text" data-pk="1" data-title="Enter username">Headphone</a></td>
                                                    <td><a href="#" class="xeditin-price" data-type="text" data-pk="1" data-title="Enter price">20.00</a></td>
                                                    <td><a href="#" class="xeditin-units" data-type="text" data-pk="1" data-title="Enter units">50</a></td>
                                                    <td><a href="#" class="xeditin-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
                                                ...
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xeditin-username" data-type="text" data-pk="1" data-title="Enter username">Car Accessories</a></td>
                                                    <td><a href="#" class="xeditin-price" data-type="text" data-pk="1" data-title="Enter price">430.00</a></td>
                                                    <td><a href="#" class="xeditin-units" data-type="text" data-pk="1" data-title="Enter units">20</a></td>
                                                    <td><a href="#" class="xeditin-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
                                                ...
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xeditin-username" data-type="text" data-pk="1" data-title="Enter username">Wrist Watch</a></td>
                                                    <td><a href="#" class="xeditin-price" data-type="text" data-pk="1" data-title="Enter price">130.00</a></td>
                                                    <td><a href="#" class="xeditin-units" data-type="text" data-pk="1" data-title="Enter units">510</a></td>
                                                    <td><a href="#" class="xeditin-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
                                                ...
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xeditin-username" data-type="text" data-pk="1" data-title="Enter username">Headphones</a></td>
                                                    <td><a href="#" class="xeditin-price" data-type="text" data-pk="1" data-title="Enter price">330.00</a></td>
                                                    <td><a href="#" class="xeditin-units" data-type="text" data-pk="1" data-title="Enter units">150</a></td>
                                                    <td><a href="#" class="xeditin-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Grid Check Box - With PopUp</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xedit-username" data-type="text" data-pk="1" data-title="Enter username">Sport Shoes</a></td>
                                                    <td><a href="#" class="xedit-price" data-type="text" data-pk="1" data-title="Enter price">30.00</a></td>
                                                    <td><a href="#" class="xedit-units" data-type="text" data-pk="1" data-title="Enter units">70</a></td>
                                                    <td><a href="#" class="xedit-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
                                                    </td>
                                                ...
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xedit-username" data-type="text" data-pk="1" data-title="Enter username">HD Laptop</a></td>
                                                    <td><a href="#" class="xedit-price" data-type="text" data-pk="1" data-title="Enter price">130.00</a></td>
                                                    <td><a href="#" class="xedit-units" data-type="text" data-pk="1" data-title="Enter units">630</a></td>
                                                    <td><a href="#" class="xedit-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
                                                ...
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xedit-username" data-type="text" data-pk="1" data-title="Enter username">Headphone</a></td>
                                                    <td><a href="#" class="xedit-price" data-type="text" data-pk="1" data-title="Enter price">20.00</a></td>
                                                    <td><a href="#" class="xedit-units" data-type="text" data-pk="1" data-title="Enter units">50</a></td>
                                                    <td><a href="#" class="xedit-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
                                                ...
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xedit-username" data-type="text" data-pk="1" data-title="Enter username">Car Accessories</a></td>
                                                    <td><a href="#" class="xedit-price" data-type="text" data-pk="1" data-title="Enter price">430.00</a></td>
                                                    <td><a href="#" class="xedit-units" data-type="text" data-pk="1" data-title="Enter units">20</a></td>
                                                    <td><a href="#" class="xedit-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
                                                ...
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xedit-username" data-type="text" data-pk="1" data-title="Enter username">Wrist Watch</a></td>
                                                    <td><a href="#" class="xedit-price" data-type="text" data-pk="1" data-title="Enter price">130.00</a></td>
                                                    <td><a href="#" class="xedit-units" data-type="text" data-pk="1" data-title="Enter units">510</a></td>
                                                    <td><a href="#" class="xedit-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
                                                ...
                                                <tr>
                                                    <th scope="row"><input tabindex="5" type="checkbox" id="square-checkbox-7" class="skin-square-orange"></th>
                                                    <td><a href="#" class="xedit-username" data-type="text" data-pk="1" data-title="Enter username">Headphones</a></td>
                                                    <td><a href="#" class="xedit-price" data-type="text" data-pk="1" data-title="Enter price">330.00</a></td>
                                                    <td><a href="#" class="xedit-units" data-type="text" data-pk="1" data-title="Enter units">150</a></td>
                                                    <td><a href="#" class="xedit-status"></a></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary">Update</button>
                                                        <button type="button" class="btn btn-sm btn-default">Cancel</button>
        ...
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
        <script src="assets/plugins/x-editable/js/bootstrap-editable.min.js" type="text/javascript"></script><script src="assets/plugins/icheck/icheck.min.js" type="text/javascript"></script><!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
