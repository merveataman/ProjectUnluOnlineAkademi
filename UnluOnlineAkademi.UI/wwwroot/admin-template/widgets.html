...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Widgets</title>
        ...
        <div class="page-container row-fluid">
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-12 col-12 float-left">
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">To Do Task Widget</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-12 col-md-6">
                                        ...
                                        <div class="ultra-widget ultra-todo-task bg-primary">
                                            ...
                                            <div class="wid-all-tasks" id="widalltasks-742822538">

                                                <ul class="list-unstyled">

                                                    <li class="checked">
                                                        <input type="checkbox" id="task-1-742822538" class="icheck-minimal-white todo-task" checked>
                                                        <label class="icheck-label form-label" for="task-1-742822538">Office Projects</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-2-742822538" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-2-742822538">Generate Invoice</label>
                                                    </li>  

                                                    <li>
                                                        <input type="checkbox" id="task-3-742822538" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-3-742822538">Ecommerce Theme</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-4-742822538" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-4-742822538">PHP and jQuery</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-5-742822538" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-5-742822538">Allocate&nbsp;Resource</label>
                                                    </li> 
                                                </ul>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-12 col-md-6">
                                        ...
                                        <div class="ultra-widget ultra-todo-task bg-purple">
                                            ...
                                            <div class="wid-all-tasks" id="widalltasks-834273044">

                                                <ul class="list-unstyled">

                                                    <li class="checked">
                                                        <input type="checkbox" id="task-1-834273044" class="icheck-minimal-white todo-task" checked>
                                                        <label class="icheck-label form-label" for="task-1-834273044">Office Projects</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-2-834273044" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-2-834273044">Generate Invoice</label>
                                                    </li>  

                                                    <li>
                                                        <input type="checkbox" id="task-3-834273044" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-3-834273044">Ecommerce Theme</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-4-834273044" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-4-834273044">PHP and jQuery</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-5-834273044" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-5-834273044">Allocate&nbsp;Resource</label>
                                                    </li> 
                                                </ul>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-12 col-md-6">
                                        ...
                                        <div class="ultra-widget ultra-todo-task bg-orange">
                                            ...
                                            <div class="wid-all-tasks" id="widalltasks-2055152848">

                                                <ul class="list-unstyled">

                                                    <li class="checked">
                                                        <input type="checkbox" id="task-1-2055152848" class="icheck-minimal-white todo-task" checked>
                                                        <label class="icheck-label form-label" for="task-1-2055152848">Office Projects</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-2-2055152848" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-2-2055152848">Generate Invoice</label>
                                                    </li>  

                                                    <li>
                                                        <input type="checkbox" id="task-3-2055152848" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-3-2055152848">Ecommerce Theme</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-4-2055152848" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-4-2055152848">PHP and jQuery</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-5-2055152848" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-5-2055152848">Allocate&nbsp;Resource</label>
                                                    </li> 
                                                </ul>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Counter & Progress Tiles</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="wid-blog">
                                            ...
                                            <div class="bg-white wid-blog-content">
                                                ...
                                                <div class="pic-wrapper col-lg-2 col-md-2 col-3 text-center float-left">
                                                    <img src="data/profile/avatar-5.png" class="" alt="">
                                                </div>
                                                <div class="info-wrapper col-lg-10 col-md-10 col-9 float-left">					
                                                    <div class="username">
                    ...
                    <div class="col-xl-8 col-lg-12 col-md-12 col-12 float-left">
                        <section class="box nobox">
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <div class="col-xl-4 col-lg-12 col-md-12 col-12 float-left">
                        <section class="box nobox">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="wid-sparkgraph bg-orange">
                                            ...
                                            <span class='float-right'><small>Resources Used</small></span>
                                            <div class="clearfix"></div>
                                        ...
                                        <div class="wid-sparkgraph bg-success">
                                            ...
                                            <span class='float-right'><small>Orders Placed</small></span>
                                            <div class="clearfix"></div>
