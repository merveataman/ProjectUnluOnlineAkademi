                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                <li>
                                    <a class="active" href="general.html"  target = '_blank' >General Admin</a>
                                </li>
                                <li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="ultra-widget ultra-todo-task bg-primary">
                                            ...
                                            <div class="wid-all-tasks" id="widalltasks-213167644">

                                                <ul class="list-unstyled">

                                                    <li class="checked">
                                                        <input type="checkbox" id="task-1-213167644" class="icheck-minimal-white todo-task" checked>
                                                        <label class="icheck-label form-label" for="task-1-213167644">Office Projects</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-2-213167644" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-2-213167644">Generate Invoice</label>
                                                    </li>  

                                                    <li>
                                                        <input type="checkbox" id="task-3-213167644" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-3-213167644">Ecommerce Theme</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-4-213167644" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-4-213167644">PHP and jQuery</label>
                                                    </li> 
                                                    <li>
                                                        <input type="checkbox" id="task-5-213167644" class="icheck-minimal-white todo-task" >
                                                        <label class="icheck-label form-label" for="task-5-213167644">Allocate&nbsp;Resource</label>
                                                    </li> 
                                                </ul>
