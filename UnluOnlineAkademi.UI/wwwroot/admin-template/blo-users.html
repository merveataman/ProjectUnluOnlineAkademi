...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : All Users</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                <li>
                                    <a class="active" href="blo-users.html" >All Users</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">All Users</h1>                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-1.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="blo-user-profile.html">Mrs. Brodeur</a></h4>
                                                        <span class='team-member-edit'><a href="blo-user-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-2.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-3.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-4.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-5.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-6.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-7.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-8.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="blo-user-profile.html">Mr. Carri Busey</a></h4>
                                                        <span class='team-member-edit'><a href="blo-user-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-9.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="blo-user-profile.html">Ms. Clay Dock</a></h4>
                                                        <span class='team-member-edit'><a href="blo-user-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-10.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="blo-user-profile.html">Mr. Mark Peskin</a></h4>
                                                        <span class='team-member-edit'><a href="blo-user-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-11.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4><a href="blo-user-profile.html">Mr. Arthur John.</a></h4>
                                                        <span class='team-member-edit'><a href="blo-user-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="team-member ">
                                                    <div class="team-img">
                                                        <img class="img-fluid" src="data/blo-users/user-12.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
