...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Draggable Panels</title>
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class="row margin-0">
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 sort_panel">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Default Panel</h2>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 sort_panel">
                            <section class="box primary">
                                <header class="panel_header">
                                    <h2 class="title float-left">Primary Panel</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 sort_panel">
                            <section class="box purple">
                                <header class="panel_header">
                                    <h2 class="title float-left">Purple Panel</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 sort_panel">
                            <section class="box orange">
                                <header class="panel_header">
                                    <h2 class="title float-left">Orange Panel</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 sort_panel">
                            <section class="box success">
                                <header class="panel_header">
                                    <h2 class="title float-left">Success Panel</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 sort_panel">
                            <section class="box warning">
                                <header class="panel_header">
                                    <h2 class="title float-left">Warning Panel</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 sort_panel">
                            <section class="box info">
                                <header class="panel_header">
                                    <h2 class="title float-left">Info Panel</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 sort_panel">
                            <section class="box danger">
                                <header class="panel_header">
                                    <h2 class="title float-left">Danger Panel</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 sort_panel">
                            <section class="box transparent">
                                <header class="panel_header">
                                    <h2 class="title float-left">Transparent Panel</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-12 sort_panel">
                            <section class="box inverted">
                                <header class="panel_header">
                                    <h2 class="title float-left">Inverted Panel</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
