...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Accordions & Tabs</title>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Accordions</h2>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <h4>Primary</h4>
                                                <div id="accordion2" role="tablist" class="accordion-group primary">
                                                    <div class="card">
                                                        <div class="card-header" role="tab" id="headingOne2">
                                                            <h5 class="mb-0">
                                                                <a data-toggle="collapse" href="#collapseOne2" role="button" aria-expanded="true" aria-controls="collapseOne2">
                                                                    Collapsible Group Item #1
                                                                </a>
                                                            </h5>
                                                        </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header" role="tab" id="headingTwo2">
                                                            <h5 class="mb-0">
                                                                <a class="collapsed" data-toggle="collapse" href="#collapseTwo2" role="button" aria-expanded="false" aria-controls="collapseTwo2">
                                                                    Collapsible Group Item #2
                                                                </a>
                                                            </h5>
                                                        </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header" role="tab" id="headingThree2">
                                                            <h5 class="mb-0">
                                                                <a class="collapsed" data-toggle="collapse" href="#collapseThree2" role="button" aria-expanded="false" aria-controls="collapseThree2">
                                                                    Collapsible Group Item #3
                                                                </a>
                                                            </h5>
                                                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <ul class="nav nav-tabs primary"  id="myTab1" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#profile-1" data-toggle="tab">
                                                            <i class="fa fa-user"></i> Profile 
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab"  href="#messages-1" data-toggle="tab">
                                                            <i class="fa fa-envelope"></i> Messages
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#settings-1" data-toggle="tab">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <ul class="nav nav-tabs transparent"  id="myTab2" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" href="#home-2" role="tab" data-toggle="tab">
                                                            <i class="fa fa-home"></i> Home
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#profile-2" data-toggle="tab">
                                                            <i class="fa fa-user"></i> Profile 
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab"  href="#messages-2" data-toggle="tab">
                                                            <i class="fa fa-envelope"></i> Messages
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#settings-2" data-toggle="tab">
                                                            <i class="fa fa-cog"></i> Settings
                                                        </a>
                                                    </li>
                                                </ul>

                                                <div class="tab-content transparent" id="myTabContent2">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <ul class="nav nav-tabs"  id="myTab3" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" href="#home-3" role="tab" data-toggle="tab">
                                                            <i class="fa fa-home"></i> Home
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#profile-3" data-toggle="tab">
                                                            <i class="fa fa-user"></i> Profile 
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab"  href="#messages-3" data-toggle="tab">
                                                            <i class="fa fa-envelope"></i> Messages
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#settings-3" data-toggle="tab">
                                                            <i class="fa fa-cog"></i> Settings
                                                        </a>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="tab-content" id="myTabContent3">
                                                    <div class="tab-pane fade show active" id="home-3">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <ul class="nav nav-tabs right-aligned"  id="myTab4" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" href="#home-4" role="tab" data-toggle="tab">
                                                            <i class="fa fa-home"></i> Home
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#profile-4" data-toggle="tab">
                                                            <i class="fa fa-user"></i> Profile 
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab"  href="#messages-4" data-toggle="tab">
                                                            <i class="fa fa-envelope"></i> Messages
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#settings-4" data-toggle="tab">
                                                            <i class="fa fa-cog"></i> Settings
                                                        </a>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="tab-content" id="myTabContent4">
                                                    <div class="tab-pane fade show active" id="home-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <ul class="nav nav-tabs float-left  vertical col-xl-3 col-lg-3 col-md-4 col-4 left-aligned primary"  id="myTab5" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" href="#home-5" role="tab" data-toggle="tab">
                                                            <i class="fa fa-home"></i> Home
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#profile-5" data-toggle="tab">
                                                            <i class="fa fa-user"></i> Profile 
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab"  href="#messages-5" data-toggle="tab">
                                                            <i class="fa fa-envelope"></i> Messages
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#settings-5" data-toggle="tab">
                                                            <i class="fa fa-cog"></i> Settings
                                                        </a>
                                                    </li>
                                                </ul>

                                                <div class="tab-content float-left  vertical col-xl-9 col-lg-9 col-md-8 col-8 left-aligned primary" id="myTabContent5">
                                                    <div class="tab-pane fade show active" id="home-5">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="tab-content float-left  vertical col-xl-9 col-lg-9 col-md-8 col-8 right-aligned primary" id="myTabContent6">
                                                    <div class="tab-pane fade show active" id="home-6">
                                                ...
                                                <ul class="nav nav-tabs float-left  vertical col-xl-3 col-lg-3 col-md-4 col-4 right-aligned primary"  id="myTab6" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" href="#home-6" role="tab" data-toggle="tab">
                                                            <i class="fa fa-home"></i> Home
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#profile-6" data-toggle="tab">
                                                            <i class="fa fa-user"></i> Profile 
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab"  href="#messages-6" data-toggle="tab">
                                                            <i class="fa fa-envelope"></i> Messages
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" role="tab" href="#settings-6" data-toggle="tab">
                                                            <i class="fa fa-cog"></i> Settings
                                                        </a>
                                                    </li>
                                                </ul>
                                            ...
                                            <br><div class="spacer clearfix"></div><br>
                                        </div>
