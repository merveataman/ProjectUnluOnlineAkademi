...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Easy Pie & Knob Charts</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            <a href="javascript:;">
                                ...
                                <span class="arrow open"></span><span class="badge badge-orange">HOT</span>
                            </a>
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper" style=''>
                        ...
                        <div class="page-title">
                            ...
                            <div class="float-right d-none">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <strong>PIE charts &amp; Knobs</strong>
                                    </li>
                                </ol>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Easy Pie Charts</h2>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Knobs</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <h3>Styles</h3><br>
                                        <div class="row">
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="80%" data-displayInput=false value="59" data-fgColor="#1fb5ac"></div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="80%" data-cursor=true data-fgColor="#1fb5ac" data-thickness=.3 value="79"></div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="80%" data-angleOffset=90 data-linecap=round value="65" data-fgColor="#1fb5ac"></div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="80%" data-angleOffset=-125 data-angleArc=250 data-fgColor="#1fb5ac" data-rotation="anticlockwise" value="75"></div>
                                        </div>
                                        <div class="clearfix"></div><br><br>

                                        <h3>Sizes & Thickness</h3><br>
                                        <div class="row">
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="60%" data-fgColor="#9972b5" data-thickness=.1 value="65"></div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="70%" data-fgColor="#9972b5" data-thickness=.2 value="65"></div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="80%" data-fgColor="#9972b5" data-thickness=.3 value="65"></div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="90%" data-fgColor="#9972b5" data-thickness=.4 value="65"></div>
                                        </div>

                                        <div class="clearfix"></div><br>
                                        <h3>Previous value indicator</h3><br>
                                        <div class="row">
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="80%" data-width="75" data-displayPrevious=true data-fgColor="#fa8564" data-skin="tron" data-cursor=true value="75" data-thickness=".2"></div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="80%" data-width="150" data-displayPrevious=true data-fgColor="#fa8564" data-skin="tron" data-thickness=".2" value="75"></div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="80%" data-width="150" data-angleOffset="180" data-fgColor="#fa8564" data-skin="tron" data-thickness=".2" value="35"></div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-12 bottom15"><input class="knob" data-width="80%" data-min="-10000"  data-angleOffset=-125 data-angleArc=250 data-displayPrevious=true data-max="10000" data-fgColor="#fa8564" data-step=".1" value="1130" data-thickness=".3"></div>
                                        </div>

                                        <div class="clearfix"></div><br><br>
                                        <div class="row">
                                            <div class="col-xl-3 col-lg-4 col-md-5 col-12 bottom15">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-10 col-12 bottom15">
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Real Time Clock</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
