...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Form Components (Advanced)</title>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class="row margin-0">
                            ...
                            <section class="box ">
                                ...
                                <div class="content-body">    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            <div class="input-group">
                                                <input type="text" value="Mon, 02 February 2015" class="form-control datepicker col-lg-6" data-format="D, dd MM yyyy">
                                                <input type="text" class="form-control timepicker col-lg-6" data-template="dropdown" data-show-seconds="true" data-default-time="09:45 PM" data-show-meridian="true" data-minute-step="5" data-second-step="5">
                                                <div class="input-group-append">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group date form_datetime" data-date="2014-05-26T05:35:07Z" data-date-format="MM dd yyyy - HH:ii p" data-link-field="dtpick_1">
                                                    ...
                                                    <div  class="input-group-append">
                                                        <span class="input-group-addon input-group-text"><span class="fa fa-times"></span></span>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Date Range</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                                ...
                                <div class="content-body">    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="daterange-2" class="form-control daterange" data-format="MM-DD-YYYY" data-start-date="02-11-2014" data-end-date="03-23-2014" data-separator=",">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="daterange daterange-text add-date-ranges" data-format="MMMM D, YYYY" data-start-date="February 19, 2015" data-end-date="March 19, 2015">
                                                    ...
                                                    <span style="margin-left: 10px;">February 19, 2015 - March 19, 2015</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text input-group-addon" id="basic-addon1" style="height: 34px;
                                                          margin-top: 1px;"><i class="sel-color" style="background-color:#da4237;"></i>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text input-group-addon" id="basic-addon1" ><i class="fa fa-eye"></i> 
                                                    </span>
                                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Spinners</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Tags</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Switches</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Select2 - select Replacement</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                            ...
                            <section class="box ">
                                ...
                                <div class="content-body">    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" placeholder="Type for Suggestions" id="typeahead-1" style="width: 100%;">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Type for Suggestions" id="typeahead-2" style="width: 100%;">
                                                </div>   
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="My Favorite Oscar Movie" id="typeahead-4" style="width: 100%;">
                                                </div>   
                                            </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Multi Select</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
