...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Other Elements</title>
                ...
                <section class="wrapper main-wrapper" style=''>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Breadcrumb</h2>
                    ...
                    <div class="row margin-0">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Group List</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <section class="box ">
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="spacer"></div>
                                        <img src="data/responsive-images/895x250.svg" class="img-fluid" alt="Responsive image">

                                        <br><div class="spacer"></div>
                                        <h5>Image Thumbnail</h5>
                                        <div class="spacer"></div>

                                        <img src="data/responsive-images/200x200.svg" alt="Image thumbnail" class="img-thumbnail">

                                        <br><div class="spacer"></div>
                                        <h5>Align images</h5>
                                        <div class="spacer"></div>
                                        <img src="data/responsive-images/200x200.svg" alt="Image thumbnail" class="img-thumbnail rounded float-left">
                                        <img src="data/responsive-images/200x200.svg" alt="Image thumbnail" class="img-thumbnail rounded float-right">
                                        <div class="spacer"></div>
                                        <img src="data/responsive-images/200x200.svg" alt="Image thumbnail" class="img-thumbnail rounded mx-auto d-block">


                                        <!-- <div class="bs-example bs-example-images" data-example-id="image-shapes">
                                             <div class="col-xl-4 col-lg-4 col-md-4 col-4">
                                                 <img data-src="data/thumb.png" class="img-rounded img-fluid" alt="140x140" src="data/thumb.png" data-holder-rendered="true">
                                             </div>
                                             <div class="col-xl-4 col-lg-4 col-md-4 col-4">
                                                 <img data-src="data/thumb.png" class="img-circle img-fluid" alt="140x140" src="data/thumb.png" data-holder-rendered="true">
                                             </div>
                                             <div class="col-xl-4 col-lg-4 col-md-4 col-4">
                                                 <img data-src="data/thumb.png" class="img-thumbnail img-fluid" alt="140x140" src="data/thumb.png" data-holder-rendered="true">
                                             </div>
                                         </div> -->
