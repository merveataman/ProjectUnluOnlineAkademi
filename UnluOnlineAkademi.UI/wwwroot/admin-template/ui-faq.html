...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : FAQ</title>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">FAQ</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="panel-group faq-panels" id="accordion">
                                            ...
                                            <h3>Sellers</h3>
                                            <div class="spacer"></div>
                                            <div id="accordion2" role="tablist" class="accordion-group">
                                                <div class="card">
                                                ...
                                                <div class="card">
                                                    <div class="card-header" role="tab" id="headingFour2">
                                                        <h5 class="mb-0">
                                                            <a class="collapsed" data-toggle="collapse" href="#collapseFour2" role="button" aria-expanded="false" aria-controls="collapseFour2">
                                                ...
                                                <div class="card">
                                                    <div class="card-header" role="tab" id="headingFive2">
                                                        <h5 class="mb-0">
                                                            <a class="collapsed" data-toggle="collapse" href="#collapseFive2" role="button" aria-expanded="false" aria-controls="collapseFive2">
                                                                When do I get paid?
                                                            </a>
                                                        </h5>
                                                    </div>
                                            ...
                                            <h3>Buyers</h3>
                                            <div class="spacer"></div>
                                            <div id="accordion3" role="tablist" class="accordion-group">
                                                <div class="card">
                                                    <div class="card-header" role="tab" id="headingOne3">
                                                        <h5 class="mb-0">
                                                            <a data-toggle="collapse" href="#collapseOne3" role="button" aria-expanded="true" aria-controls="collapseOne3">
                                                ...
                                                <div class="card">
                                                    <div class="card-header" role="tab" id="headingTwo3">
                                                        <h5 class="mb-0">
                                                            <a class="collapsed" data-toggle="collapse" href="#collapseTwo3" role="button" aria-expanded="false" aria-controls="collapseTwo3">
