...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Single Page</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="blo-page-view.html" >View Page</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Single Page</h1>                            </div>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Single Page</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="blog_post full_blog_post">
                                            <h3><a href="ui-blog-item.html">About Us</a></h3>
                                            ...
                                            <form class="form row">
                                                <div class="form-group col-9">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class=" form-control col-lg-12" id="inputName">
                                                    </div>
                                                </div>
                                                <div class="form-group col-9">
                                                ...
                                                <div class="form-group col-9">
                                                    ...
                                                    <div class="controls">
                                                        <textarea class=" form-control col-lg-12" id="inputComment" rows="6"></textarea>
                                                    </div>
                                                </div>
