...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Gallery</title>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Filterable Gallery</h2>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div id='portfolio' class="">
                                            ...
                                            <div class="portfolio-items">
                                                <div class="portfolio-item col-lg-4 col-md-6 col-12  creative">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-fluid" src="data/gallery/01.jpg" alt="">
                                                ...
                                                <div class="portfolio-item col-lg-4 col-md-6 col-12  corporate portfolio">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-fluid" src="data/gallery/02.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                ...
                                                <div class="portfolio-item col-lg-4 col-md-6 col-12  creative">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-fluid" src="data/gallery/03.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                ...
                                                <div class="portfolio-item col-lg-4 col-md-6 col-12  corporate">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-fluid" src="data/gallery/04.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                ...
                                                <div class="portfolio-item col-lg-4 col-md-6 col-12  creative portfolio">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-fluid" src="data/gallery/05.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                ...
                                                <div class="portfolio-item col-lg-4 col-md-6 col-12  corporate">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-fluid" src="data/gallery/06.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                            <h3>Portfolio Item 5</h3>
                                                            <span class='desc'>A brief description area for the portfolio item.</span>
                                                ...
                                                <div class="portfolio-item col-lg-4 col-md-6 col-12  creative portfolio">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-fluid" src="data/gallery/07.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
                                                ...
                                                <div class="portfolio-item col-lg-4 col-md-6 col-12  corporate">
                                                    <div class="portfolio-item-inner">
                                                        <img class="img-fluid" src="data/gallery/08.jpg" alt="">
                                                        <div class="portfolio-info animated fadeInUp animated-duration-600ms">
