...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Form Validations</title>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class="row margin-0">
                        <div class="col-xl-6">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Message Validations</h2>
                        ...
                        <div class="col-xl-6">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Iconic Validations</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                        ...
                        <div class="col-xl-12">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">General Field Validations</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
                                ...
                                <div class="content-body">    <div class="row">
                                        ...
                                        <form id="general_validate" action="javascript:;" novalidate="novalidate" style="width: 100%;">
