...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Vector Maps</title>
            ...
            <section id="main-content" class=" ">
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Countries and Cities</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="tabs-vertical-env">
                                            <ul class="nav nav-tabs vertical col-xl-3 col-lg-3 col-md-3 col-3 left-aligned " style="max-height:550px;overflow:auto;">
                                            ...
                                            <div class="tab-content vertical col-xl-9 col-lg-9 col-md-9 col-9 left-aligned">
