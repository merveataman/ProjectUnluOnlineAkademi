...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : User Profile</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="blo-user-profile.html" >User Profile</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="uprofile-image">
                                            <img src="data/blo-users/user-1.jpg" class="img-fluid">
                                        </div>
                                        <div class="uprofile-name">
                                            ...
                                            <p class="uprofile-title">Editor</p>
                                        </div>
