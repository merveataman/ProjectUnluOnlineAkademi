...
{
    public class UpdateAboutUsCommandHandler : IRequestHandler<UpdateAboutUsCommand, bool>
    {
        private readonly IGenericRepository<Domain.Entities.AboutUs> _repository;
        private readonly IMapper _mapper;

        public UpdateAboutUsCommandHandler(IGenericRepository<Domain.Entities.AboutUs> repository, IMapper mapper)
        {
